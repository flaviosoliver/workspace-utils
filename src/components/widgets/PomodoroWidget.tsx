        ...
        <div className='mb-6 p-4 bg-gray-800 rounded-lg border border-gray-700'>
          ...
          <div className='grid grid-cols-2 gap-4'>
            <div>
              ...
              <input
                aria-label='Duração do trabalho'
                type='number'
                min='1'
                max='60'
            ...
            <div>
              ...
              <input
                aria-label='Duração do intervalo curto'
                type='number'
                min='1'
                max='30'
            ...
            <div>
              ...
              <input
                aria-label='Duração do intervalo longo'
                type='number'
                min='1'
                max='60'
            ...
            <div>
              ...
              <input
                aria-label='Sessões até intervalo longo'
                type='number'
                min='2'
                max='10'
      ...
      <div className='flex-1 flex flex-col items-center justify-center'>
        ...
        >
          ...
          <div
            ...
            style={{
              background: `conic-gradient(${phaseInfo.color.replace(
                'text-',
                ''
              )} ${progress * 3.6}deg, transparent 0deg)`,
              mask: 'radial-gradient(circle, transparent 45%, black 45%, black 55%, transparent 55%)',
              WebkitMask:
                'radial-gradient(circle, transparent 45%, black 45%, black 55%, transparent 55%)',
            }}
          />
        </div>
