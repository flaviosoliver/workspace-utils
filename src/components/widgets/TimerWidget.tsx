...
export default function TimerWidget() {
  ...
  const progress =
    time > 0
      ? ((inputMinutes * 60 + inputSeconds - time) /
      ...
      <div className='relative mb-8'>
        <div className='w-48 h-48 rounded-full border-4 border-gray-700 flex items-center justify-center relative overflow-hidden'>
          ...
          <div className='text-4xl font-mono font-bold text-white z-10'>
            {time > 0
              ? formatTime(time)
              : formatTime(inputMinutes * 60 + inputSeconds)}
          </div>
        </div>
      </div>
        ...
        <div className='mb-6 space-y-4'>
          <div className='flex items-center gap-2'>
            ...
            <input
              ...
              value={inputMinutes}
              onChange={(e) =>
                setInputMinutes(Math.max(0, parseInt(e.target.value) || 0))
              }
