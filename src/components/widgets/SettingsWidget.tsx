          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  <label className="text-white font-medium">Notificações do sistema</label>
                  <p className="text-gray-400 text-sm">Receber notificações do navegador</p>
                </div>
                <input
                  type="checkbox"
              ...
              <div className="flex items-center justify-between">
                <div>
                  <label className="text-white font-medium">Sons de notificação</label>
                  <p className="text-gray-400 text-sm">Reproduzir sons para alertas</p>
                </div>
                <input
                  type="checkbox"
                  defaultChecked
